...
urlpatterns = [
    ...
    path('add-carousel-image/', CarouselImageCreateView.as_view(), name='add_carousel_image'),
    path('delete-carousel-image/<int:pk>/', CarouselImageDeleteView.as_view(), name='delete_carousel_image'),
]
